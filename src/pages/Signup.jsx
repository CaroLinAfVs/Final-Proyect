    ...
    return (
        <div className="signup">
            <div className="containerSignup">
                ...
                <div className="data">
                    <h4>Name:</h4>
                    <Input width="300px" value={name} onChange={e => setName(e.target.value)} size='md'></Input>
                    <h4>Email:</h4>
                    <Input width="300px" value={email} onChange={(event) => setEmail(event.target.value)} placeholder="user@user.com" size='md'></Input>
                    <h4>Password:</h4>
                    <p>(5 caracteres minimo)</p>
                    <Input width="300px" value={password} onChange={handlePasswordStrengthChange} type="password" size='md'></Input>
                    <div style={{
                        height: "6px",
                        width: "300px",
                        marginTop: "8px",
